...
public:
  ...
  NodeType nodeType() { return NodeType::Field; }

  /// return the default traversal order
  TraversalOrder traversalOrder() { return TraversalOrder::BeforeChildren; }
};
...
public:
  ...
  NodeType nodeType() { return NodeType::Section; }
...
public:
  ...
  NodeType nodeType() { return NodeType::Section; }
  TraversalOrder traversalOrder() { return TraversalOrder::AfterChildren; }
};
